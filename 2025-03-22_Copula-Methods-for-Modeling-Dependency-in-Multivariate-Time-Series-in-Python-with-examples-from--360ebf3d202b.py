...
def retrieve_interest_rates_from_fred() -> None:
    np.random.seed(42)
...
def fetch_real_macroeconomic_data_from_fred() -> None:
...
def main() -> None:
    retrieve_interest_rates_from_fred()
    fetch_real_macroeconomic_data_from_fred()
